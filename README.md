...
## Testing
To run the tests navigate to the server directory and execute the following command in your terminal: `npm run start:client`
#### Test cases
